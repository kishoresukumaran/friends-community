...
export default async function FifaPage() {
  ...
  return (
    <main className="mx-auto max-w-5xl px-4 py-8 sm:px-6 sm:py-12">
      <div className="mb-8">
        <nav className="flex items-center gap-1.5 text-sm font-semibold text-white/50">
          <Link href="/contests" className="transition hover:text-white/80">
            Contests
          </Link>
          <span className="text-white/30">/</span>
          <span className="text-white/70">FIFA 2026</span>
        </nav>
